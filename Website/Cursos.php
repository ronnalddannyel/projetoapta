...
$totalRegistrosQuery = mysqli_query($conn, "SELECT COUNT(*) as total FROM CursosDoPolo");
$totalRegistros = mysqli_fetch_assoc($totalRegistrosQuery)['total'];
$totalPaginas = ceil($totalRegistros / $registrosPorPagina);

// Consulta para obter os registros da página atual
$resultadosQuery = mysqli_query($conn, "SELECT * FROM CursosDoPolo ORDER BY cursos_polo_id LIMIT $offset, $registrosPorPagina");
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <?php while ($resultado = mysqli_fetch_assoc($resultadosQuery)): ?>
                    ...
                    <img src="<?php echo $upload_dir ?>poloimagem.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
